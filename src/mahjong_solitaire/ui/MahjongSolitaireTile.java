...
public class MahjongSolitaireTile extends Sprite
{
     ...
     * 
     * @param testTile The tile to compare this tile to.
     * 
    ...
    public boolean match(MahjongSolitaireTile testTile)
    {
        ...
        if (this.getTileType().equals(testTile.getTileType())) {
            ...
            // OTHERWISE RETURN TRUE IF BOTH THE SAME KIND OF PLANT
                return true;
        }
        else
            return false;
    ...
    public void updateWinPath(MiniGame game)
    {
        ...
        if (calculateDistanceToTarget() < MAX_TILE_VELOCITY)
        {
            ...
            winPathIndex += 2;
            winPathIndex %= (WIN_PATH_NODES * 2)+0;
        }
